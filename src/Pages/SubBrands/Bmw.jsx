    ...
    return (
        <div>
            <div className="carousel w-full mb-20 mt-5">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute ml-[50px] lg:ml-[100px] mt-[70px] max-w-lg">
                        <h1 className="text-2xl font-bold text-red-700">WELLCOME BMW HANT</h1>
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="absolute ml-[50px] lg:ml-[100px] mt-[70px] max-w-lg">
                        <h1 className="text-2xl font-bold text-red-700">WELLCOME TO BMW HANT</h1>
            ...
            <div className="max-w-6xl mx-auto">
                {
                    cars.length>0?cars.map(car => <BmwCars key={car._id} car={car}></BmwCars>)
                    :<div>
