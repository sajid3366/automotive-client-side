    ...
    return (
        <div>
            <div className="bg-gray-100 rounded-lg mb-8 px-5 py-3 lg:flex gap-12">
                <img className="w-full lg:w-[450px] rounded-lg h-[350px]" src={photo} alt="" />
                <div className="lg:w-1/2">
                    ...
                    <div className=" mt-10 lg:mt-24 flex justify-between w-full">
                        <Link to={`/ferrari/${_id}`}><p className="bg-red-600 text-xl font-semibold  text-white px-4 py-2 rounded-sm cursor-pointer">View Details</p></Link>
                        <Link to={`/update/${_id}`}>
